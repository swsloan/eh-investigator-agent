...
export class AgentSession extends EventEmitter {
  ...
  linkWorkspaceResources(dotDir) {
    ...
    // No subagent roster is linked in: #120 slice 1 shipped one and measured it,
    // and the cases that delegated cost 27% MORE than their own baselines (see
    // docs/DESIGN-multi-agent-investigation.md). The delegation instrumentation
    // stays — it is how any future attempt gets judged — but nothing here offers
    // the agent a specialist to spawn.
  }
