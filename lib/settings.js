...
const DEFAULTS = {
  ...
  memory: {
    ...
    // endpoint works (Ollama by default). Read by the sidecar at startup via
    // graphiti/runtime/embedder.env, so changes apply on a memory-stack restart.
    embedder: {
      ...
      endpoint: 'http://ollama:11434/v1', // OpenAI-compatible base URL
    },
  },
  extrahop: {
