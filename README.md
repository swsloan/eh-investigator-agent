...
```bash
EXCLI_ARCHIVE=/path/to/excli-darwin-arm64-0.0.158-3bfbf25b6b.tar.gz ./start.sh
```
...
`vendor/excli-linux-amd64-0.0.158-3bfbf25b6b.tar.gz`, the bootstrap script can discover it:
