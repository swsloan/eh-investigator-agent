...
const EXTRAHOP_ACTIONS = {
  ...
  search_detectionlogs: 'Search Detection Logs',
  search_networkusers: 'Search Network Users',
  get_eql_schema: 'Get EQL Schema',
  get_eql_fieldvalues: 'Get EQL Field Values',
  get_eql_syntax: 'Get EQL Syntax',
  preview_tuningrule: 'Preview Tuning Rule',
  create_tuningrule: 'Create Tuning Rule',
  get_exmcp_version: 'Get excli Version',
