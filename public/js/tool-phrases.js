...
const EXTRAHOP_PHRASES = {
  ...
  search_detectionlogs: 'Searching detection logs',
  search_networkusers: 'Searching network users',
  get_eql_schema: 'Reading the EQL schema',
  get_eql_fieldvalues: 'Listing EQL field values',
  get_eql_syntax: 'Reading EQL syntax',
  preview_tuningrule: 'Previewing a tuning rule',
  create_tuningrule: 'Creating a tuning rule',
  get_exmcp_version: 'Checking the excli version',
